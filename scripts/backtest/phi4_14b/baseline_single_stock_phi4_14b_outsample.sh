...
#$ -l gpu=2
#$ -P inf_fincomputing
#$ -o ~/look-ahead-bias/logs/server-logs/baseline-single-stock-phi4_14b.out
#$ -e ~/look-ahead-bias/logs/server-logs/baseline-single-stock-phi4_14b.err
...
python -m benchmark.backtest.ai_hedge_fund.eval \
  ...
  > "logs/baseline_single_stock_${TICKER}_phi4_14b_outsample.log" 2>&1 &

echo "PID: $!"
echo "Log: tail -f logs/baseline_single_stock_${TICKER}_phi4_14b_outsample.log"
